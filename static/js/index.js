document.getElementById('btn').addEventListener('click', ()=>{
  ...
  axios({
    ...
    if (res.data === true){
      ...
      '<img id="warning" src="/static/img/warning2.ico" alt="image not found">'
    }
    else if(res.data === false){
      document.getElementById('loading-icon').style.display='none'
      divRes.innerHTML  = '<span class="green">The website is safe</span>'+
      '<img id="succeeded" src="/static/img/succeeded.png" height="64px" width="64px" alt="image not found">'
    }
    else{
      document.getElementById('loading-icon').style.display='none'
